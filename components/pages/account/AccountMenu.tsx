...
import { FaClipboardList, FaRegHeart, FaShoppingCart, FaUser } from 'react-icons/fa';
...
const accountsMenu = [
    { title: "Orders", icon: <IoBookmark />, href: "/account/orders" },
    ...
    { title: "Your Transactions", icon: <PiCurrencyDollarSimpleFill />, href: "/account/transactions" },
