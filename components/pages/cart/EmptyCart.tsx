    ...
    <div className="py-10 md:py-20 flex items-center justify-center p-4">
      ...
      >
        ...
        <div>
          <Link
            href="/"
            className="block bg-tech_dark_color/5 border border-tech_dark_color/20 text-center py-2.5 rounded-full text-sm font-semibold tracking-wide hover:border-tech_dark_color hover:bg-tech_dark_color hover:text-white hoverEffect"
          >
            Discover Products
          </Link>
        </div>
