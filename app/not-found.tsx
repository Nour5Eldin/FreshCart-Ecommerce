      ...
      <div className="h-full min-h-screen flex flex-col items-center justify-center px-4">
        <div className="max-w-md mx-auto">
          <div className="text-center">
            <SubLogo className="w-48 mx-auto" />
          ...
          <div className="mt-8 space-y-6">
            <div className="rounded-md shadow-xs space-y-4">
              <Link
                href={"/"}
                className="w-full flex items-center justify-center px-4 py-2 border border-transparent text-sm rounded-md text-white bg-tech_blue/80 hover:bg-tech_blue font-semibold focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-black hoverEffect"
